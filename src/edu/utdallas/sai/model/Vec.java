 ...
 * the robot will move. Assuming the center of the robot is the origin the angles can
...
public class Vec {
     ...
     * @param centerX Screen X coordinate of the center of the robot sprite.
     * @param centerY Screen Y coordinate of the center of the robot sprite.
     */
     ...
     * @param mouseX Converts the mouse X coordinate into Cartesian system based on the robot center X (originX).
     * @param originX The robot center point's X coordinate.
     ...
     * @param mouseY  Converts the mouse Y coordinate into Cartesian system based on the robot center Y (originY).
     * @param originY The robot center point's Y coordinate.
